...
const AppContent = () => {
    ...
    <div style={{ 
      ...
      <div style={{ padding: '80px 20px 120px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '20px', color: '#6b7280', marginBottom: '40px', maxWidth: '500px', margin: '0 auto 40px auto' }}>
  ...
  // Simple Admin Page
  const AdminPage = () => (
    <div style={{ minHeight: '100vh', padding: '40px 20px', background: 'linear-gradient(135deg, #fee2e2 0%, #ffffff 100%)' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <h1 style={{ fontSize: '48px', fontWeight: 'bold', color: '#1f2937', marginBottom: '20px', textAlign: 'center' }}>
          Admin Dashboard
        </h1>
        <p style={{ fontSize: '18px', color: '#6b7280', marginBottom: '40px', textAlign: 'center' }}>
          Manage certificates and system settings
        </p>
        <div style={{ background: 'white', padding: '40px', borderRadius: '12px', boxShadow: '0 10px 25px rgba(0,0,0,0.1)' }}>
          <p>Welcome to the Admin Dashboard, {user?.name}!</p>
          <p>You have {user?.role} privileges.</p>
        </div>
      </div>
    </div>
  );
          ...
          element={
            <ProtectedRoute allowedRoles={['verifier', 'admin']}>
              <div style={{ padding: '40px', textAlign: 'center' }}>
                <h1>Bulk Verification Tool</h1>
                <p>Available for Verifiers and Admins</p>
              </div>
            </ProtectedRoute>
          } 
        />
          ...
          element={
            <ProtectedRoute>
              <div style={{ padding: '40px', textAlign: 'center' }}>
                ...
                <p>Available for all authenticated users</p>
              </div>
            </ProtectedRoute>
          } 
        />
